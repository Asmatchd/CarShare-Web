...
export default function RideTable(props) {
  const rowEvents = {
  ...
  return (
    <MDBContainer className="rounded z-depth-2 " fluid>
      <MDBRow className="col-lg-12 ">
        <MDBCol md="12">
          <h3 className=" green-text">Rides</h3>
          <ToolkitProvider
            keyField="props.state.state.rideDataArray._id"
            data={props.state.state.rideDataArray}
            columns={columns}
            search={{
